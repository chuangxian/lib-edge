...
public class LibEdgeAuthorizationConfiguration {
  ...
  public RedisTemplate libEdgeAuthorizationRedisTemplate(
    ...
    JedisConnectionFactory factory = new JedisConnectionFactory(standaloneConfiguration, builder.build());
  ...
  public RedisTemplate libEdgeSessionRedisTemplate(
    ...
    RedisStandaloneConfiguration envConfiguration = new RedisStandaloneConfiguration();
